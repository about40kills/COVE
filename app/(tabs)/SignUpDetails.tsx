...
export default function SignUpDetailsScreen() {
  ...
  const handleCreateAccount = async () => {
    try {
      ...
      router.push('/FindFriends'); // Ensure this is correct for your navigation
    } catch (error) {
      console.error('Error creating user details:', (error as Error).message);
    }
  };
    ...
    <View style={styles.container}>
      <View style={{ top: 150 }}>
        ...
        <View style={{ gap: 15 }}>
          ...
          <View>
            <Text style={{ bottom: 2, color: "#3A3A3A", fontSize: 15 }}>Display Name</Text>
            <TextInput
              style={styles.input}
        ...
        <TouchableOpacity style={styles.create} onPress={handleCreateAccount}>
